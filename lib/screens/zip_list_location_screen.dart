...
class ZipListLocationScreen extends StatefulWidget {
  const ZipListLocationScreen({super.key});

  @override
  State<ZipListLocationScreen> createState() => _ZipListLocationScreenState();
}

class _ZipListLocationScreenState extends State<ZipListLocationScreen> {
